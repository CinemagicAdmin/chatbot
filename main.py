...
from bigquery_client import get_cached_schema, get_cached_delivery_schema, get_cached_products, get_cached_machines, run_query, refresh_caches
...
async def chat(req: ChatRequest):
    try:
        ...
        sql = generate_sql(req.message, schema, delivery_schema, products, machines, req.history)
